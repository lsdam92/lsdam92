...
//			sql.append("	into customer (id,name,pass,emailid,emaildomain,joindate) \n");
			sql.append("	into customer (id,name,pass,address) \n");
			sql.append("	values(?,?,?,?) \n");
...
//				 다시 시도하세요.
		...
		if(cnt != 0 ) {
			...
			out.println("<a href=\"/myjquery/user/login.html\">로그인</a>");
		}else {
